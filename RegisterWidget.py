#TODO dodanie pola na wprowadzenie loginu i zapisywanie użytkownika do bazy jako: "login" - "wektor"
from PySide6 import QtWidgets, QtCore, QtGui

class RegisterWidget(QtWidgets.QWidget):
    startRegisterProces = QtCore.Signal(list)
    ...
    def __init__(self):
        ...
        for _ in range(self.MAX_STEPS):
            ...
            indicator.setFixedSize(50, 15)  # Rozmiar prostokąta
    ...
    def stop_ui_feedback(self, success=None, audio_data=None):
        ...
        if success is True:
            ...
            if self.progress_step == self.MAX_STEPS:
                ...
                self.startRegisterProces.emit(self.audio_samples) #rozpoczęcie rejestracji - uśrednianie wszystkich nagrań i zapisanie do bazy
            else:
